						...
						<ul class="links">
							<li><h5>로그인</h5></li>
								<form action = "LoginController" method="post">
									<li><input type="text"  placeholder="Email을 입력하세요" name="Input_Id"></li>
									<li><input type="password"  placeholder="PW를 입력하세요" name="Input_Pw"></li>
						...
						<ul class="actions vertical">
							<li><h5>회원가입</h5></li>
								...
								<form action = "JoinController">
									...
									<li><span id ="idCheckMsg">중복 처리</span></li>
				...
				<!-- Banner -->
					<section id="banner" class="major">
						<div class="inner">
							<header class="major">
										<h1>
										    <%= session.getAttribute("userId") != null ? session.getAttribute("userId") + "님 환영합니다" : "로그인 해주세요" %>
										</h1>
